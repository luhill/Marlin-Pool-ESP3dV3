 ...
 */
  ...
  #define PROBE_PT_2_X -103.92 
  #define PROBE_PT_2_Y 60
  #define PROBE_PT_3_X -PROBE_PT_2_X
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 256 //At least 256 for high speed delta. Big enough to buffer through screen updates?
#else
